...
class _HomeVistaState extends State<HomeVista> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('\u{1F4DA} Tinta & Hojas', style: TextStyle(fontSize: 18)),
        centerTitle: true,
        actions: [
          if (auth.esAdmin)
            IconButton(
          ...
          Badge(
            ...
            label: Text('${carrito.cantidadItems}', style: const TextStyle(fontSize: 10)),
            child: IconButton(
    ...
    return SliverToBoxAdapter(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Constantes.vinoDark.withAlpha(80), blurRadius: 10, offset: const Offset(0, 4)),
          ],
        ),
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: Center(
                child: Icon(Icons.menu_book_rounded, size: 56, color: Colors.white.withAlpha(45)),
              ),
            ),
            // Contenido
            Padding(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('Ver catálogo', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 12)),
                    ),
                  ),
                ],
              ),
    ...
    return SliverToBoxAdapter(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
          ...
          child: Text('Géneros', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontFamily: 'Playfair Display', fontWeight: FontWeight.bold)),
        ),
        SizedBox(
          height: 40,
            ...
            itemBuilder: (_, index) {
              ...
              return Padding(
                ...
                child: ChoiceChip(
                  ...
                  labelStyle: TextStyle(color: sel ? Colors.white : Constantes.textDark, fontSize: 13),
                  side: BorderSide(color: sel ? Constantes.vinoPrimary : Constantes.vinoSoft),
  ...
  Widget _buildDestacadosSliver(LibroProvider librosProv, CarritoProvider carrito) {
    return SliverToBoxAdapter(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
          padding: const EdgeInsets.fromLTRB(16, 20, 16, 8),
          child: Text('Libros Destacados', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontFamily: 'Playfair Display', fontWeight: FontWeight.bold)),
        ),
        SizedBox(
          height: 250,
          child: ListView.builder(
                  ...
                  child: TarjetaLibro(
                    ...
                    onAgregarCarrito: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('${libro.titulo} agregado al carrito'), backgroundColor: Colors.green[700], behavior: SnackBarBehavior.floating),
                      );
                    },
                  ),
                ),
  ...
  Widget _buildTodosLosLibrosSliver(LibroProvider librosProv, CarritoProvider carrito) {
    final libros = librosProv.libros;
    return SliverToBoxAdapter(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
          padding: const EdgeInsets.fromLTRB(16, 20, 16, 8),
          child: Text('Todos los libros', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontFamily: 'Playfair Display', fontWeight: FontWeight.bold)),
        ),
        if (libros.isEmpty)
          const Padding(padding: EdgeInsets.all(32), child: Center(child: Text('No hay libros disponibles')))
        else
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 12),
...
class _ShimmerItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Container(width: 80, height: 110, decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(8))),
          const SizedBox(width: 12),
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Container(height: 16, decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(4))),
              const SizedBox(height: 8),
              Container(height: 12, width: 120, decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(4))),
              const SizedBox(height: 8),
              Container(height: 12, width: 80, decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(4))),
            ]),
          ),
        ],
      ),
